...
export {
  ...
  ANIMATION_SOURCE, ANIMATION_STATUS, GESTURE_SOURCE, INITIAL_CONTAINER_LAYOUT, INITIAL_LAYOUT_VALUE, KEYBOARD_BEHAVIOR,
  KEYBOARD_BLUR_BEHAVIOR, KEYBOARD_DISMISS_THRESHOLD, KEYBOARD_INPUT_MODE, KEYBOARD_STATUS, MODAL_STACK_BEHAVIOR, SCREEN_HEIGHT,
  SCREEN_WIDTH,
